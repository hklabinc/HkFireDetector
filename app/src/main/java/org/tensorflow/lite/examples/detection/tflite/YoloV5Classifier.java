...
public class YoloV5Classifier implements Classifier {
    public static YoloV5Classifier create(
        ...
        String actualFilename = labelFilename.split("file:///android_asset/")[1];       // 수정해야 (첫번째 것만 읽어들이는 듯)
...
//        int[] intValues = new int[INPUT_SIZE * INPUT_SIZE];
    ...
    public ArrayList<Recognition> recognizeImage(Bitmap bitmap) {
        ...
        HashMap<String,String> nameMap = new HashMap<String,String>(){{
            put("smoke", "smoke");      // added by hhchoi
            put("fire", "fire");        // added by hhchoi

            put("person", "person");
            put("bicycle", "bicycle");
            put("car", "car");
            put("motorbike", "motorbike");
            put("aeroplane", "aeroplane");
            put("bus", "bus");
            put("train", "train");
            put("truck", "truck");
            put("boat", "boat");
            put("traffic light", "traffic light");
            put("fire hydrant", "fire hydrant");
            put("stop sign", "stop sign");
            put("parking meter", "parking meter");
            put("bench", "bench");
            put("bird", "bird");
            put("cat", "cat");
            put("dog", "dog");
            ...
            put("handbag", "handbag");
            put("tie", "tie");
            put("suitcase", "suitcase");
            put("frisbee", "frisbee");
            put("skis", "skis");
            put("snowboard", "snowboard");
            put("sports ball", "sports ball");
            put("kite", "kite");
            put("baseball bat", "baseball bat");
            put("baseball glove", "baseball glove");
            put("skateboard", "skateboard");
            put("surfboard", "surfboard");
            put("tennis racket", "tennis racket");
            put("bottle", "bottle");
            put("wine glass", "wine glass");
            put("cup", "cup");
            put("fork", "fork");
            put("knife", "knife");
            put("spoon", "spoon");
            ...
            put("chair", "chair");
            put("sofa", "sofa");
            put("potted plant", "potted plant");
            put("bed", "bed");
            put("dining table", "dining table");
            put("toilet", "toilet");
            put("tvmonitor", "tvmonitor");
            put("laptop", "laptop");
            put("mouse", "mouse");
            put("remote", "remote");
            put("keyboard", "keyboard");
            put("cell phone", "cell phone");
            ...
            put("hair drier", "hair drier");
            put("toothbrush", "toothbrush");
